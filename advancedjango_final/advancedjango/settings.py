...
SECRET_KEY = 'zxtzcve-w_dl$86=fd*4h$+*gr@7z72i#80k9qt49fuura#g@v'
...
MIDDLEWARE = [
    ...
    #'advancedjangoapp.middleware.CustomMiddleware',
...
ASGI_APPLICATION = 'advancedjango.asgi.application'
